...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-butterfly-995a
```

A live public deployment of this template is available at [https://frosty-butterfly-995a.templates.workers.dev](https://frosty-butterfly-995a.templates.workers.dev)
